...
mycur = f.cursor()
mycur.execute("create database MyHome;")
f.commit()
mycur.execute("use MyHome;")
print("database created")

que = "create table residents(USERNAME varchar(20), PASSWORD varchar(20), UNITNO varchar(10), EMAIL varchar(60) NOT NULL primary key, PHONENO varchar(10), ISADMIN varchar(10));"
mycur.execute(que)
print("table residents created")
f.commit()

que = "create table PendingApprovals(USERNAME varchar(20), PASSWORD varchar(20), UNITNO varchar(10), EMAIL varchar(60) NOT NULL primary key, PHONENO varchar(10));"
mycur.execute(que)
print("table PendingApprovals created")
f.commit()

que = "create table facilities(NAME varchar(20) NOT NULL primary key, DESCRIPTION varchar(400));"
mycur.execute(que)
print("table facilities created")
f.commit()

que = "create table bookings(FACILITYNAME varchar(20), EMAIL varchar(60), DATE date, TIME varchar(20));"
mycur.execute(que)
...
mycur.execute("insert into bookings(FACILITYNAME, EMAIL, DATE, TIME)values('{}','{}','{}','{}')".format("Badminton", "clark@gmail.com", "2021-1-1", "5PM to 6PM"))
mycur.execute("insert into bookings(FACILITYNAME, EMAIL, DATE, TIME)values('{}','{}','{}','{}')".format("Tennis", "ruby@gmail.com", "2020-12-29", "4PM to 5PM"))
mycur.execute("insert into bookings(FACILITYNAME, EMAIL, DATE, TIME)values('{}','{}','{}','{}')".format("Billiards", "george@hotmail.com", "2020-12-31", "5PM to 6PM"))
mycur.execute("insert into bookings(FACILITYNAME, EMAIL, DATE, TIME)values('{}','{}','{}','{}')".format("Badminton", "emily@yahoo.com", "2021-1-5", "7PM to 8PM"))
f.commit()